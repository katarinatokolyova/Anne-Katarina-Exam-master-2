...
var Eventplatform = (function () {
    ...
    //method for writing a comment Testing the comment method 
    module.sendComment2 = function (comment) {
        console.log("inde i send comment")
    ...
    module.getRandomPicture = function () {
        ...
        fetch(url, options)
          .then(response => response.json())
          .then(results => {
            console.log(results.recipes[0].image) // This contains an URL to a random image of a random meal
